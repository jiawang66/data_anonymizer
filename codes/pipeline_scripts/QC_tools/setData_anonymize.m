...
% ----- set path ----------------------------------------------------------
dataDir = '/data/share/Epilepsy_SPICE_20221011/';            % path of the data
processFolder = '/data/share/temp/Epilepsy_SPICE_20221011/'; % path of the data after anony
...
tarDir = '/data/';   % Folder on the target server to save the data
